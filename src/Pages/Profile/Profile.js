...
export default function Profile() {
    ...
    return (
        <div className='profile'>
            ...
            <Button href='https://drive.google.com/file/d/1EFWswoJX7Ua9MtzROlJEbV-1hFAi3YRe/view?usp=sharing' target='_blank' rel="noopener noreferrer" className='btn-cv' >Ver curriculum</Button>
